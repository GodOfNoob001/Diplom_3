...
class TestMainPage:
    ...
    @allure.title('При нажатии на кнопку "Конструктор" '
                  'в шапке веб-сервиса - происходит редирект на страницу с конструктором заказа')
    ...
    @allure.title('При нажатии на кнопку "Лента Заказов" '
                  'в шапке веб-сервиса - происходит редирект на страницу с конструктором заказа')
    ...
    @allure.title('При нажатии на "Ингредиент" '
                  'в Конструкторе заказа веб-сервиса - открывается модальное окно ингредиента')
    def test_success_ingredient_modal(self, main_page):
        main_page.open_main()
        main_page.click_ingredient()
        assert main_page.is_modal_visible()

    @allure.title('При нажатии на крестик в модальном окне Ингредиента -'
